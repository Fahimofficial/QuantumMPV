...
class GlUtilsTest {
    ...
    fun checkFramebuffer_complete() {
        ...
        every { GLES20.glCheckFramebufferStatus(GLES20.GL_FRAMEBUFFER) } returns GLES30.GL_FRAMEBUFFER_COMPLETE
    ...
    fun checkFramebuffer_incomplete() {
        ...
        every { GLES20.glCheckFramebufferStatus(GLES20.GL_FRAMEBUFFER) } returns errorCode
