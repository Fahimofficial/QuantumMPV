...
package com.quantummpv.app.domain.anime4k
...
class Anime4KManager(
  ...
  enum class Quality(
    ...
    FAST("S", com.quantummpv.app.R.string.anime4k_quality_fast),
    BALANCED("M", com.quantummpv.app.R.string.anime4k_quality_balanced),
    HIGH("L", com.quantummpv.app.R.string.anime4k_quality_high),
  }
  ...
  enum class Mode(
    ...
    OFF(com.quantummpv.app.R.string.anime4k_mode_off),
    A(com.quantummpv.app.R.string.anime4k_mode_a),
    B(com.quantummpv.app.R.string.anime4k_mode_b),
    C(com.quantummpv.app.R.string.anime4k_mode_c),
    A_PLUS(com.quantummpv.app.R.string.anime4k_mode_a_plus),
