...
import com.quantummpv.app.data.network.XtreamClient
...
val DatabaseModule =
  module {
    ...
    single {
      com.quantummpv.app.database.repository.SecureFolderRepository(
    ...
    single {
      com.quantummpv.app.repository.JellyfinRepository(
        dao = get(),
        client = get(),
      )
    }
    ...
    single {
      com.quantummpv.app.data.navidrome.NavidromeClient(
        httpClient = get(),
        json = get(),
      )
    }
