...
package com.quantummpv.app.presentation.components
    ...
    title = {
      Text(
        androidx.compose.ui.res
          .stringResource(com.quantummpv.app.R.string.pref_preferences),
      )
    },
    content = {
      Text(
        androidx.compose.ui.res
          .stringResource(com.quantummpv.app.R.string.pref_appearance_summary),
      )
    },
