...
import com.quantummpv.app.ui.browser.cards.FolderCard
...
import com.quantummpv.app.ui.browser.dialogs.FileSystemSortDialog
 ...
 */
@Serializable
object FileSystemBrowserRootScreen : com.quantummpv.app.presentation.Screen {
...
data class FileSystemDirectoryScreen(
  val path: String,
) : com.quantummpv.app.presentation.Screen {
  @OptIn(ExperimentalPermissionsApi::class)
  @Composable
  override fun Content() {
...
fun FileSystemBrowserScreen(path: String? = null) {
  ...
  var swipeRenameVideo by remember { mutableStateOf<com.quantummpv.app.domain.media.model.Video?>(null) }
  var swipeDeleteVideo by remember { mutableStateOf<com.quantummpv.app.domain.media.model.Video?>(null) }
  ...
  com.quantummpv.app.ui.browser.NavigationBarSelectionEffect(isInSelectionMode)
  val isActiveRoot = isAtRoot && com.quantummpv.app.ui.utils.LocalNavigationPageActive.current
  androidx.lifecycle.compose.LifecycleResumeEffect(isActiveRoot, showBottomNavigation, isPermissionSetupCompleted) {
    if (isActiveRoot) {
      try {
        val mainScreenObj = com.quantummpv.app.ui.browser.MainScreen
      ...
      try {
        val results =
          if (isAtRoot) {
            items
              ...
              .flatMap { storageVolume ->
                runCatching {
                  ...
                  com.quantummpv.app.ui.browser.filesystem.searchRecursively(
                    context,
                    storageVolume.path,
                    searchQuery,
                  )
            ...
            com.quantummpv.app.ui.browser.filesystem
  ...
  com.quantummpv.app.ui.browser.fab.FabScrollHelper.trackScrollForFabVisibility(
    listState = listState,
    gridState = if (mediaLayoutMode == com.quantummpv.app.preferences.MediaLayoutMode.GRID) gridState else null,
        ...
        if (isAtRoot) {
          val isFabShouldBeVisible =
            showQuickPlayFab &&
              !isInSelectionMode &&
              isFabVisible.value &&
              !com.quantummpv.app.ui.browser.MainScreen
                ...
                ToggleFloatingActionButton(
                  ...
                  onCheckedChange = {
                    if (quickPlayFabDirect) {
                      coroutineScope.launch {
                        val lastPlayed =
                          com.quantummpv.app.utils.history.RecentlyPlayedOps
                            .getLastPlayedEntity()
                        if (lastPlayed != null) {
                          MediaUtils.playFile(
              ...
              FloatingActionButtonMenuItem(
                onClick = {
                  ...
                  coroutineScope.launch {
                    val recentlyPlayedVideos =
                      com.quantummpv.app.utils.history.RecentlyPlayedOps.getRecentlyPlayed(
                        limit = 1,
                      )
                ...
                text = {
                  Text(
                    text =
                      androidx.compose.ui.res.stringResource(
                        com.quantummpv.app.R.string.pref_advanced_enable_recently_played_title,
                      ),
                  )
                },
              )
              ...
              FloatingActionButtonMenuItem(
                ...
                text = {
                  Text(
                    text =
                      androidx.compose.ui.res
                        .stringResource(com.quantummpv.app.R.string.ui_open_link),
                  )
                },
              )
            }
...
private suspend fun collectVideosRecursively(
  context: Context,
  folderPath: String,
): List<com.quantummpv.app.domain.media.model.Video> {
  val videos = mutableListOf<com.quantummpv.app.domain.media.model.Video>()
...
private fun playVideosAsPlaylist(
  context: Context,
  videos: List<com.quantummpv.app.domain.media.model.Video>,
) {
...
private fun FileSystemBrowserContent(
  ...
  error: String?,
  isAtRoot: Boolean,
  breadcrumbs: List<com.quantummpv.app.domain.browser.PathComponent>,
  ...
  onRename: ((com.quantummpv.app.domain.media.model.Video) -> Unit)? = null,
  onDelete: ((com.quantummpv.app.domain.media.model.Video) -> Unit)? = null,
  onBreadcrumbClick: (com.quantummpv.app.domain.browser.PathComponent) -> Unit,
  selectionManager: com.quantummpv.app.ui.browser.selection.SelectionManager<FileSystemItem, String>,
              ...
              LazyVerticalGrid(
                ...
                if (!isAtRoot && breadcrumbs.isNotEmpty()) {
                  item(span = { GridItemSpan(maxLineSpan) }) {
                    com.quantummpv.app.ui.browser.filesystem.BreadcrumbNavigation(
                      breadcrumbs = breadcrumbs,
