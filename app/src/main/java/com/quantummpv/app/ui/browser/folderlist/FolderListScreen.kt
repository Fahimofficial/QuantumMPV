...
package com.quantummpv.app.ui.browser.folderlist
...
import com.quantummpv.app.ui.browser.states.LoadingState
...
object FolderListScreen : Screen {
  ...
  internal fun MediaStoreFolderListContent(
    ...
    val secureFolderRepository = koinInject<com.quantummpv.app.database.repository.SecureFolderRepository>()
    val secureFolderPreferences = koinInject<com.quantummpv.app.preferences.SecureFolderPreferences>()
    ...
    LaunchedEffect(permissionState.status, isPermissionSetupCompleted) {
      com.quantummpv.app.ui.browser.MainScreen.updatePermissionState(
      ...
      Scaffold(
        ...
        topBar = {
          if (embedded) {
              ...
              placeholder = {
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_search_folders_and_videos),
                )
              },
              leadingIcon = {
                Icon(
            ...
            BrowserTopBar(
              title = stringResource(com.quantummpv.app.R.string.app_name),
              ...
              onBlacklistClick = {
                coroutineScope.launch {
                  ...
                  val scope = if (audioOnly) com.quantummpv.app.preferences.BlacklistScope.AUDIO_ONLY else com.quantummpv.app.preferences.BlacklistScope.VIDEO_ONLY
        ...
        Box(modifier = Modifier.weight(0.6f)) {
          key(selectedFolderBucketId) {
            CompositionLocalProvider(
              com.quantummpv.app.ui.browser.LocalNavigationBarHeight provides 0.dp,
            ) {
              VideoListScreen(
                ...
                is CopyPasteOps.OperationType.Move -> {
                  ...
                  if (needFallback.isNotEmpty()) {
                    ...
                    for (folder in needFallback) {
                      val videos =
                        com.quantummpv.app.repository.MediaFileRepository.getVideosForBuckets(
                          context,
...
private fun FolderListContent(
  ...
  foldersWithNewCount: List<com.quantummpv.app.ui.browser.folderlist.FolderWithNewCount>,
  ...
  selectionManager: com.quantummpv.app.ui.browser.selection.SelectionManager<VideoFolder, String>,
            ...
            if (folder.path in pinnedFolderPaths) {
              {
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_pinned),
...
private fun SearchResultsContent(
  ...
  navigationBarHeight: androidx.compose.ui.unit.Dp,
  onFolderClick: (com.quantummpv.app.domain.media.model.VideoFolder) -> Unit,
