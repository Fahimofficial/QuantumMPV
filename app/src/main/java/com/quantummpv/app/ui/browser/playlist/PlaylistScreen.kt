...
object PlaylistScreen : Screen {
      ...
      if (selectedPlaylist != null) {
        ...
        androidx.compose.material3.AlertDialog(
          ...
          title = {
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_rename_playlist),
            )
          },
          text = {
          ...
          confirmButton = {
            androidx.compose.material3.TextButton(
              ...
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.rename),
              )
            }
          },
          dismissButton = {
  ...
  private fun PlaylistListContent(
    ...
    selectionManager: com.quantummpv.app.ui.browser.selection.SelectionManager<PlaylistWithCount, Int>,
