      ...
      Column(
        ...
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_loading_video_info),
        )
      }
    }
    return
      ...
      CenterAlignedTopAppBar(
        ...
        title = {
          Text(
            text =
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_compressor),
        ...
        navigationIcon = {
          IconButton(onClick = onClose) {
            Icon(
              ...
              contentDescription =
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_close),
            )
          }
        },
        actions = {
          IconButton(onClick = onShowSettings) {
            Icon(
              ...
              contentDescription =
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_settings),
            )
          }
          IconButton(onClick = onShowInfo) {
            Icon(
              ...
              contentDescription =
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.info),
            )
          }
        },
      )
  ...
  ElevatedCard(
    ...
    Column(
      ...
      Row(
        ...
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_save_to),
      ...
      FlowRow(
        ...
        FilterChip(
          ...
          label = {
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_current_folder),
            )
          },
        )
        FilterChip(
          ...
          label = {
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_movies_compressor),
            )
          },
        )
      }
    ...
    Row(
      ...
      Column(
        ...
        Text(
          text =
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_estimated),
          style = MaterialTheme.typography.labelMedium,
          color = MaterialTheme.colorScheme.primary,
        )
        Text(
...
private fun CompressorPresetsTab(
  ...
  Column(
    ...
    Text(
      androidx.compose.ui.res
        .stringResource(com.quantummpv.app.R.string.ui_change_video_quality),
      style = MaterialTheme.typography.titleMedium,
      fontWeight = FontWeight.SemiBold,
    )
    ...
    if (state.showTargetSizePreset) {
      ...
      if (sizePresets.isNotEmpty()) {
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_target_size_presets),
          style = MaterialTheme.typography.titleMedium,
          fontWeight = FontWeight.SemiBold,
        )
        FlowRow(
...
private fun CompressorVideoTab(
  ...
  Column(
    ...
    Text(
      androidx.compose.ui.res
        .stringResource(com.quantummpv.app.R.string.ui_advanced_options),
      style = MaterialTheme.typography.titleMedium,
      fontWeight = FontWeight.SemiBold,
    )
    ...
    Text(
      androidx.compose.ui.res
        .stringResource(com.quantummpv.app.R.string.ui_target_size),
    ...
    Text(
      androidx.compose.ui.res
        .stringResource(com.quantummpv.app.R.string.ui_encoding),
      style = MaterialTheme.typography.labelLarge,
    )
    Row(
      ...
      if (state.supportedCodecs.contains(androidx.media3.common.MimeTypes.VIDEO_AV1)) {
        FilterChip(
          ...
          label = {
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_av1),
            )
          },
        )
      }
      if (state.supportedCodecs.contains(androidx.media3.common.MimeTypes.VIDEO_H265)) {
        FilterChip(
          ...
          label = {
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_h_265),
            )
          },
        )
      }
      FilterChip(
        ...
        label = {
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_h_264),
          )
        },
      )
    }
    ...
    Text(
      androidx.compose.ui.res
        .stringResource(com.quantummpv.app.R.string.ui_resolution),
      style = MaterialTheme.typography.labelLarge,
    )
    ...
    Text(
      androidx.compose.ui.res
        .stringResource(com.quantummpv.app.R.string.ui_framerate),
      style = MaterialTheme.typography.labelLarge,
    )
    Row(
      modifier = Modifier.horizontalScroll(rememberScrollState()),
      ...
      FilterChip(
        ...
        label = {
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_60fps),
          )
        },
      )
      FilterChip(
        ...
        label = {
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_30fps),
          )
        },
      )
      FilterChip(
        ...
        label = {
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_24fps),
          )
        },
      )
    }
...
private fun CompressorAudioTab(
  ...
  Column(
    ...
    Text(
      androidx.compose.ui.res
        .stringResource(com.quantummpv.app.R.string.ui_audio_options),
      style = MaterialTheme.typography.titleMedium,
      fontWeight = FontWeight.SemiBold,
    )
    ...
    Row(
      ...
      Text(
        androidx.compose.ui.res
          .stringResource(com.quantummpv.app.R.string.ui_remove_audio),
    ...
    AnimatedVisibility(visible = !state.removeAudio) {
      Column(verticalArrangement = Arrangement.spacedBy(18.dp)) {
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_audio_bitrate),
          style = MaterialTheme.typography.labelLarge,
        )
        Row(
          modifier = Modifier.horizontalScroll(rememberScrollState()),
        ...
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.compressor_volume),
          style = MaterialTheme.typography.labelLarge,
        )
        Row(
          modifier = Modifier.fillMaxWidth(),
        ...
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.compressor_volume_hint),
          style = MaterialTheme.typography.bodySmall,
          color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
      }
    ...
    Column(
      ...
      ElevatedCard(
        ...
        Column(
          ...
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_compressing_video),
            style = MaterialTheme.typography.labelLarge,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
          Text(
      ...
      Column(
        ...
        ElevatedCard(
          ...
          Column(
            ...
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_saved_to),
              fontWeight = FontWeight.SemiBold,
            )
            Text(
        ...
        if (state.warnings.isNotEmpty()) {
          ElevatedCard(
            ...
            Column(
              ...
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_warnings),
                fontWeight = FontWeight.SemiBold,
        ...
        if (!state.isBatch) {
          Row(
            ...
            Button(
              ...
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.generic_share),
              )
            }
            FilledTonalButton(
              onClick = onSave,
              ...
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_save_copy),
              )
            }
          }
        }
        ...
        TextButton(onClick = onClose) {
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_back_to_list),
          )
        }
      }
    }
  ...
  AlertDialog(
    ...
    title = {
      Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_device_and_app_info),
          style = MaterialTheme.typography.titleLarge,
        )
        Text(
          androidx.compose.ui.res
    ...
    text = {
      Column(
        ...
        Row(
          ...
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_show_bitrate),
          )
        ...
        if (state.showBitrate) {
          Row(
            ...
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_use_mbps),
            )
        ...
        Row(
          ...
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_preserve_metadata),
          )
        ...
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_supported_codecs),
          style = MaterialTheme.typography.labelLarge,
          color = MaterialTheme.colorScheme.primary,
        )
    ...
    confirmButton = {
      Row {
        ...
        TextButton(
          ...
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_copy),
          )
        }
      }
    },
