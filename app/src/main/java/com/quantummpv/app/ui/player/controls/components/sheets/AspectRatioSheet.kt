  ...
  PlayerSheet(onDismissRequest) {
    Column(
      ...
      Text(
        text =
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_presets),
      ...
      if (customRatios.isNotEmpty()) {
        Text(
          text =
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.pref_gesture_double_tap_custom),
          style = MaterialTheme.typography.titleSmall,
          modifier =
            Modifier
              .padding(horizontal = MaterialTheme.spacing.medium)
...
private fun AddCustomRatioRow(
  ...
  Column(
    ...
    Text(
      text =
        androidx.compose.ui.res
          .stringResource(com.quantummpv.app.R.string.ui_add_custom_ratio_e_g_16_9),
      style = MaterialTheme.typography.titleSmall,
    ...
    Row(
      ...
      OutlinedTextField(
        ...
        label = {
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_width),
          )
        },
      ...
      OutlinedTextField(
        ...
        label = {
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_height),
          )
        },
        isError = errorMessage != null,
        keyboardOptions =
      ...
      FilledTonalIconButton(
        ...
        Icon(
          ...
          contentDescription =
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_add),
        )
      }
    }
