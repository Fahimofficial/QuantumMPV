        ...
        Row {
          ...
          IconButton(onClick = { onDelete(connection) }) {
            Icon(
              ...
              contentDescription =
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.delete),
        ...
        Text(
          text =
            androidx.compose.ui.res.stringResource(
              com.quantummpv.app.R.string.ui_connect_automatically_on_app_launch,
            ),
          style = MaterialTheme.typography.bodySmall,
          color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
          ...
          isConnecting -> {
            FilledTonalButton(
              ...
              Row(
                ...
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_connecting),
                  color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.38f),
                )
              }
            }
          ...
          isConnected -> {
            Row(
              ...
              FilledTonalButton(
                ...
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_browse),
                )
              }
              ...
              FilledTonalButton(
                ...
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_disconnect),
                )
              }
            }
          }
            ...
            FilledTonalButton(
              ...
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_connect),
              )
            }
          }
        }
