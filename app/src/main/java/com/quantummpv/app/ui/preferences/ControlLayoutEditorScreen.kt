              ...
              AppSymbolIcon(
                ...
                contentDescription =
                  androidx.compose.ui.res.stringResource(
                    com.quantummpv.app.R.string.pref_layout_reset_default,
                  ),
              )
            }
          },
        ...
        LazyVerticalGrid(
          ...
          item(span = { GridItemSpan(maxLineSpan) }) {
            androidx.compose.material3.Text(
              text =
                androidx.compose.ui.res.stringResource(
                  com.quantummpv.app.R.string.ui_long_press_to_reorder_items_tap_the_icon_to_remove_them,
                ),
              ...
              androidx.compose.material3.Surface(
                ...
                androidx.compose.foundation.layout.Column(
                  ...
                  androidx.compose.material3.Text(
                    text =
                      androidx.compose.ui.res.stringResource(
                        com.quantummpv.app.R.string.ui_drop_zone_is_empty,
                      ),
                  ...
                  androidx.compose.material3.Text(
                    text =
                      androidx.compose.ui.res.stringResource(
                        com.quantummpv.app.R.string.ui_tap_buttons_from_the_available_palette_below,
                      ),
                ...
                if (availableButtons.isEmpty()) {
                  androidx.compose.foundation.layout.Box(
                    ...
                    androidx.compose.material3.Text(
                      text =
                        androidx.compose.ui.res.stringResource(
                          com.quantummpv.app.R.string.ui_all_available_buttons_are_in_use,
                        ),
                      style = MaterialTheme.typography.bodySmall,
                      color = MaterialTheme.colorScheme.onSurfaceVariant,
                    )
    ...
    androidx.compose.foundation.layout.Column(
      ...
      androidx.compose.foundation.layout.Column {
        Text(
          text =
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_icons_legend),
        ...
        Text(
          text =
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_what_is_each_icon_for),
          style = MaterialTheme.typography.bodySmall,
          color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
      }
      ...
      FlowRow(
        ...
        allPlayerButtons.forEach { button ->
          androidx.compose.foundation.layout.Row(
            ...
            Text(
              text =
                com.quantummpv.app.preferences
