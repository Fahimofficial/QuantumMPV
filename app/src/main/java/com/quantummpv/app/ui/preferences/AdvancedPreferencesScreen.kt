          ...
          item {
            PreferenceCard {
              ...
              Preference(
                ...
                summary = {
                  val sizeStr = FormatUtils.formatFileSize(configCacheSize)
                  Column {
                    Text(
              ...
              Preference(
                ...
                summary = {
                  val sizeStr = FormatUtils.formatFileSize(thumbnailCacheSize)
                  Column {
                    Text(
              ...
              Preference(
                ...
                summary = {
                  val sizeStr = FormatUtils.formatFileSize(fontsCacheSize)
                  Text(
