...
import com.quantummpv.app.ui.browser.cards.rememberVideoCardUiConfig
...
import com.quantummpv.app.ui.browser.folderlist.FolderListViewModel
...
import com.quantummpv.app.ui.browser.videolist.VideoListViewModel
 ...
 * browsing/sort experience as [com.quantummpv.app.ui.browser.folderlist.FolderListScreen]), drill
 * into one and multi-select videos using the app's own [rememberSelectionManager] + [BrowserTopBar]
 * (same as [com.quantummpv.app.ui.browser.videolist.VideoListScreen]), then add them to the
 * playlist via [PlaylistDetailViewModel.addVideosToPlaylist] — mirrors
 * [com.quantummpv.app.ui.securefolder.SecureFolderAddFilesScreen] for the Secure Folder flow.
 */
@Serializable
