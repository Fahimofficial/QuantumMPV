...
package com.quantummpv.app.ui.browser.medialibrary
            ...
            Text(
              if (mediaType ==
                ...
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_search_audio)
              } else {
                androidx.compose.ui.res
              ...
              EmptyState(
                ...
                title =
                  if (mediaType ==
                    ...
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_no_audio_found)
                  } else {
                    androidx.compose.ui.res
