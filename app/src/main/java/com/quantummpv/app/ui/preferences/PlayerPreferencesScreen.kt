...
val savePositionOnQuit by preferences.savePositionOnQuit.collectAsState()
              ...
              SwitchPreference(
                ...
                onValueChange = { enabled ->
                  ...
                  val componentName = ComponentName(context, "com.quantummpv.app.ui.mediainfo.MediaInfoActivityAlias")
                  val newState =
                    if (enabled) {
                ...
                title = {
                  Text(
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_show_media_info_in_chooser),
                  )
                },
                summary = {
                  Text(
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_show_media_info_in_system),
                    color = MaterialTheme.colorScheme.outline,
                  )
                },
              )
              ...
              SwitchPreference(
                ...
                onValueChange = { enabled ->
                  ...
                  val componentName = ComponentName(context, "com.quantummpv.app.ui.player.WebStreamLinksActivityAlias")
                  val newState =
                    if (enabled) {
                      PackageManager.COMPONENT_ENABLED_STATE_ENABLED
                    } else {
                      ...
                      Column {
                        ...
                        TextField(
                          ...
                          placeholder = {
                            Text(
                              androidx.compose.ui.res
                                .stringResource(com.quantummpv.app.R.string.ui_e_g_intro_opening_op),
                            )
                          },
                          singleLine = true,
                        )
                      ...
                      Column {
                        ...
                        TextField(
                          ...
                          placeholder = {
                            Text(
                              androidx.compose.ui.res
                                .stringResource(com.quantummpv.app.R.string.ui_e_g_outro_ending_ed),
                            )
                          },
                          singleLine = true,
                        )
            ...
            PreferenceCard {
              ...
              ListPreference(
                ...
                title = {
                  Text(
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_image_format),
                  )
                },
                summary = {
                  Text(
                ...
                title = {
                  Text(
                    androidx.compose.ui.res.stringResource(
                      com.quantummpv.app.R.string.ui_include_subtitles_in_screenshots,
                    ),
                  )
                },
              )
              ...
              Preference(
                ...
                title = {
                  Text(
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_filename_template),
                  )
                },
              ...
              SliderPreference(
                ...
                title = {
                  Text(
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_jpeg_webp_quality),
                  )
                },
                valueRange = 1f..100f,
              ...
              SliderPreference(
                ...
                title = {
                  Text(
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_png_compression),
                  )
                },
                valueRange = 0f..9f,
              ...
              if (screenshotFormat == ScreenshotFormat.WEBP) {
                ...
                SwitchPreference(
                  ...
                  title = {
                    Text(
                      androidx.compose.ui.res
                        .stringResource(com.quantummpv.app.R.string.ui_webp_lossless),
                    )
                  },
                  summary = {
                    Text(
                      androidx.compose.ui.res.stringResource(
                        com.quantummpv.app.R.string.ui_uses_mpv_native_lossless_output_android_fallback_uses_lossless_o,
                      ),
                      color = MaterialTheme.colorScheme.outline,
                    )
                  },
      ...
      AlertDialog(
          ...
          Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            OutlinedTextField(
              ...
              label = {
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_template),
                )
              },
              modifier = Modifier.fillMaxWidth(),
            )
            Text(
              text =
                androidx.compose.ui.res.stringResource(
                  com.quantummpv.app.R.string.ui_use_placeholders_to_customize_the_screenshot_filename_n,
                ) +
        ...
        confirmButton = {
          TextButton(
            ...
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_save),
            )
          }
        },
        dismissButton = {
