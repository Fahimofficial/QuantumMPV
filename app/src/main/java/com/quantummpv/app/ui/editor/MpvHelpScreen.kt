...
package com.quantummpv.app.ui.editor
            ...
            Text(
              text =
                androidx.compose.ui.res.stringResource(
                  com.quantummpv.app.R.string.ui_mpv_documentation,
                ),
        ...
        com.quantummpv.app.ui.components.InlineSearchBar(
          ...
          placeholder = {
            Text(
              text =
                androidx.compose.ui.res.stringResource(
                  com.quantummpv.app.R.string.ui_search_commands_options_properties,
                ),
            ...
            AnimatedVisibility(
              ...
              IconButton(onClick = { searchQuery = "" }) {
                Icon(
                  ...
                  contentDescription =
                    androidx.compose.ui.res.stringResource(
                      com.quantummpv.app.R.string.pref_clear_content_desc,
                    ),
                  tint = MaterialTheme.colorScheme.outline,
                )
              }
          ...
          Box(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
              ...
              Text(
                text =
                  androidx.compose.ui.res.stringResource(
                    com.quantummpv.app.R.string.ui_no_results_found,
                  ),
        ...
        if (!entry.androidCompatible) {
          Surface(
            ...
            Text(
              text =
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_no_android),
