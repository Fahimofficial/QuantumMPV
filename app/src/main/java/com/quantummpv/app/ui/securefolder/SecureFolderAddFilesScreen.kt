 ...
 * experience as [com.quantummpv.app.ui.browser.folderlist.FolderListScreen]), drill into one and
 * multi-select videos using the app's own [rememberSelectionManager] + [BrowserTopBar] (same as
 * [com.quantummpv.app.ui.browser.videolist.VideoListScreen]), then move them in — all without
