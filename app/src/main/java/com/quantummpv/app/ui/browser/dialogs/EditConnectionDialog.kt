      ...
      Text(
        text =
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_edit_connection),
      ...
      Column(
        ...
        Row(
          ...
          OutlinedTextField(
            ...
            label = {
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_name),
                maxLines = 1,
          ...
          ExposedDropdownMenuBox(
            ...
            OutlinedTextField(
              ...
              label = {
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_protocol),
                  maxLines = 1,
                  overflow = TextOverflow.Ellipsis,
                )
              },
        ...
        OutlinedTextField(
          ...
          label = {
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_host_ip_address),
              maxLines = 1,
              overflow = TextOverflow.Ellipsis,
            )
          },
        ...
        Row(
          ...
          OutlinedTextField(
            ...
            label = {
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_port),
                maxLines = 1,
                overflow = TextOverflow.Ellipsis,
              )
            },
          ...
          OutlinedTextField(
            ...
            label = {
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_path),
                maxLines = 1,
                overflow = TextOverflow.Ellipsis,
              )
            },
        ...
        Row(
          ...
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_anonymous_guest_access),
          )
        }
        ...
        if (protocol == NetworkProtocol.WEBDAV) {
          Row(
            ...
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_use_https_secure_connection),
            )
          }
        }
        ...
        Row(
          ...
          OutlinedTextField(
            ...
            label = {
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_username),
                maxLines = 1,
                overflow = TextOverflow.Ellipsis,
              )
            },
          ...
          OutlinedTextField(
            ...
            label = {
              Text(
                androidx.compose.ui.res
                  .stringResource(
                    com.quantummpv.app.R.string.ui_new_password_keep_existing,
                  ),
                maxLines = 1,
                overflow = TextOverflow.Ellipsis,
              )
        ...
        Row(
          ...
          Text(
            androidx.compose.ui.res
              .stringResource(com.quantummpv.app.R.string.ui_clear_saved_password),
          )
        }
      }
    },
