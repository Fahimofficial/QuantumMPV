            ...
            PreferenceCard {
                  ...
                  Text(
                    text =
                      androidx.compose.ui.res.stringResource(
                        com.quantummpv.app.R.string.ui_dual_pane_view,
                      ),
                  )
                },
                summary = {
                  Text(
                    text =
                      androidx.compose.ui.res.stringResource(
                        com.quantummpv.app.R.string.ui_enable_dual_pane_layout_on_tablets_in_folder_view,
                      ),
                    color = MaterialTheme.colorScheme.outline,
                  )
                },
              ...
              SwitchPreference(
                ...
                title = {
                  Text(
                    androidx.compose.ui.res.stringResource(
                      com.quantummpv.app.R.string.ui_delete_folder_all_contents,
                    ),
                  )
                },
                summary = {
