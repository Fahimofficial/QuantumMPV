          ...
          item {
            PreferenceCard {
                ...
                title = {
                  Text(
                    androidx.compose.ui.res
                      .stringResource(com.quantummpv.app.R.string.ui_include_audio_files),
                  )
                },
                summary = {
                  Text(
                    androidx.compose.ui.res.stringResource(
                      com.quantummpv.app.R.string.ui_show_audio_files_in_the_browser,
                    ),
              ...
              Column(
                ...
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_minimum_audio_duration),
