...
import com.quantummpv.app.ui.browser.dialogs.SharedAddServerDialog
import com.quantummpv.app.ui.browser.dialogs.SharedManageServersDialog
...
fun AddJellyfinServerDialog(
  ...
  onDismiss: () -> Unit,
  onConnect:
  (serverUrl: String, serverName: String, authMode: JellyfinAuthMode, username: String, password: String, token: String) -> Unit,
) {
  if (!isOpen) return
