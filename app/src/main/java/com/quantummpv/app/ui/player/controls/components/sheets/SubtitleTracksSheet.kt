      ...
      title = {
        Text(
          androidx.compose.ui.res
            .stringResource(com.quantummpv.app.R.string.ui_translate_to),
        )
      },
      text = {
        Column(verticalArrangement = Arrangement.spacedBy(MaterialTheme.spacing.small)) {
          OutlinedTextField(
            ...
            placeholder = {
              Text(
                androidx.compose.ui.res
                  .stringResource(com.quantummpv.app.R.string.ui_search_language),
              )
            },
            singleLine = true,
          ...
          LazyColumn(modifier = Modifier.height(280.dp)) {
            ...
            if (languagesToShow.isEmpty()) {
              item {
                Text(
                  androidx.compose.ui.res
                    .stringResource(com.quantummpv.app.R.string.ui_no_languages_found),
              ...
              Icon(
                ...
                contentDescription =
                  androidx.compose.ui.res.stringResource(
                    com.quantummpv.app.R.string.ui_cancel_translation,
                  ),
      ...
      if (translationEnabled) {
        IconButton(onClick = onTranslate) {
          Icon(
            ...
            contentDescription =
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_translate),
          )
        }
      }
