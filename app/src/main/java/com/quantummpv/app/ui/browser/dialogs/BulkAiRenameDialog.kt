          ...
          !canUseAi ->
            Text(
              androidx.compose.ui.res.stringResource(
                com.quantummpv.app.R.string.ui_ai_rename_is_disabled_enable_it_in_settings_ai_integration,
              ),
                      ...
                      label = {
                        Text(
                          androidx.compose.ui.res
                            .stringResource(com.quantummpv.app.R.string.ui_new_name),
                        )
                      },
      ...
      when (phase) {
        RenamePhase.IDLE ->
          Button(
            ...
            Text(
              androidx.compose.ui.res
                .stringResource(com.quantummpv.app.R.string.ui_generate_previews),
              fontWeight = FontWeight.Bold,
            )
          }
        ...
        RenamePhase.PREVIEW -> {
          ...
          Button(
            ...
            Icon(
              imageVector = com.quantummpv.app.ui.icons.Icons.RoundedFilled.DriveFileRenameOutline,
              contentDescription = null,
              modifier = Modifier.size(18.dp),
            )
            Spacer(Modifier.width(8.dp))
